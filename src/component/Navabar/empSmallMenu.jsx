...
export default function EmpSmallMenu() {
  ...
  return (
    <React.Fragment >
      ...
      >
        ...
        <div className='dd'>
        <MenuItem>
          <Avatar /><Link style={{color:'black',textDecoration:'none',marginLeft:'10px'}} to='/employee_profile'>PROFILE</Link>
        </MenuItem>
        </div>
        <div className='dd'>
        <MenuItem>
